    ...
    <div class="flex flex-col overflow-auto" style="height: 600px">
        ...
        <div class="px-3 grid grid-cols-5 items-center justify-center py-4">
            <div class="col-start-2 col-span-3 p-4 shadow-lg rounded-lg  divide-y space-y-2">
                ...
                <form action="{{route('update_skill',["career_plan_id"=>$career_plan_id,'employee_id'=>$employee_id,'skill_id'=>$skill_id])}}" class="py-2 text-gray-700 space-y-3" method="post">
                    @method('put')
                    @csrf
                    <fieldset class="border border-gray-100 rounded-lg p-2 ">
                        ...
                        <div class="form-field-container">
                            ...
                            <input type="text" name="name" id="name" class="form-input" value="{{$skill->name}}">
                        </div>
                        ...
                        <div class="form-field-container">
                            ...
                            <select name="state" id="state" class="form-input">
                                <option value="0" selected> non acquise </option>
                    ...
                    <fieldset class="border border-gray-100 rounded-lg p-2 ">
                        ...
                        <div class="form-field-container">
                            ...
                            <select name="skill_type" id="skill_type" class="form-input">
                                <option value="soft_skill" selected> competence douce </option>
                        ...
                        <div class="form-field-container">
                            ...
                            <textarea class="form-input" name="actions_plan" id="actions_plan">{{$skill->actions_plan}}</textarea>
