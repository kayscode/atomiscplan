                    ...
                    @foreach($formations as $formation)
                        <div class="shadow-sm text-center border border-gray-200 pb-2 space-y-2">
                            @if($formation->is_published)
                                <p class="py-2 p-1 text-lg uppercase bg-green-400 text-white">
                                    publier
                                </p>
                            @else
                            ...
                            <div class="py-2 text-right px-2 ">
                                <a href="{{route("show_formation",["formation_id"=>$formation->id])}}" class="px-4 py-2 border border-indigo-400 text-indigo-500 font-semibold"> voir </a>
                            </div>
                        </div>
                    @endforeach
                </div>
