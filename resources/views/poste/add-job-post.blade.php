    ...
    <div class="flex flex-col overflow-auto" style="height: 600px">
        ...
        <div class="px-3 grid grid-cols-5 items-center justify-center py-4">
            <div class="col-start-2 col-span-3 p-4 shadow-lg rounded-lg  divide-y space-y-2">
                ...
                <h1 class="text-indigo-500 font-semibold text-center py-3 capitalize text-lg" > créer un poste </h1>
                <form action="{{route('store_job')}}" class="py-2 text-gray-700 space-y-1" method="post">
                    @csrf
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div>
                                <div class="form-field-container">
                                    ...
                                    <input type="number" name="year_of_experience" id="year_of_experience" class="form-input">
                                </div>
                        ...
                        <div class="grid grid-cols-2 gap-x-2">
                            ...
                            <div>
                                <div class="form-field-container">
                                    ...
                                    <input type="text" name="position_code" id="position_code" class="form-input">
                                </div>
                                @error('position_code')
                                    <div class="text-red-500 px-2 pt-1">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-field-container">
                            ...
                            <textarea name="hard_skills" id="hard_skills" class="form-input"></textarea>
                        </div>
                        @error("hard_skills")
                        <div class="text-red-500 px-2 pt-1">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="form-field-container">
                            ...
                            <textarea name="soft_skills" id="soft_skills" class="form-input"></textarea>
                        </div>
                        @error("soft_skills")
                        <div class="text-red-500 px-2 pt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mt-3 text-center">
                        <input type="submit" value="ajouter comptence" class="bg-indigo-500 text-white font-semibold rounded-lg px-5 py-3">
                    </div>
                </form>
            </div>
        </div>
